...
Genomes with cas genes are identified with the following code (after previous steps have been carried out in identifyCRISPRcasSystems.sh).
...
genomes <- read.table("~/Desktop/Project/identifycasproteins//refseq_79.genomes_summary.txt", header = T, sep = '\t', as.is = T, comment.char = '')
